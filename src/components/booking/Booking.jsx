...
export default function Booking(){
    return(
        ...
        <label htmlFor="language" className="option">
            ...
            <select id="language">
                <option value="lang" class="bold-option">Language</option>
        ...
        <label htmlFor="category" className="option">
            ...
            <select id="category">
                <option value="category" class="bold-option">Category</option>
        ...
        <label htmlFor="rating" className="option">
            ...
            <select id="rating">
                <option value="rate" className="bold-option">Rating</option>
        ...
        <label htmlFor="experience" className="option">
            ...
            <select id="experience">
                <option value="expe" class="bold-option">Years of Experience</option>
    ...
    <section className="booking-button">
                <button type="submit">Book a Therapist for me</button>
            </section>
